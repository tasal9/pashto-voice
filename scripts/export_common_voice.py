...
def main() -> int:
    ...
    audio_group.add_argument("--copy-audio", action="store_true", help="Copy audio files into clips/.")
    audio_group.add_argument("--symlink-audio", action="store_true", help="Symlink audio files into clips/.")
